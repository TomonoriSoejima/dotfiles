...
# Creates a temporary workspace that includes dotfiles, copilot, utilities, and the case folder
# Usage: open-case <case-directory-or-number>
# Example: open-case 02057624
#          open-case /Users/surfer/tickets/02057624-Storage_is_high
open-case() {
    local case_dir="$1"
    ...
    local workspace_file="/tmp/elastic-case-${case_name}.code-workspace"
...
EOF
    ...
    echo "Opened case workspace: $case_name"
}
